describe("password_is_valid", function() {
  it("password should meet all requirements", function() {
    expect(function(){
      let result = password_is_valid("qwer9P");
    }).toThrow(new  Error("password is invalid"));
 });
...
describe("password_is_ok", function() {
  it("should check if password has +8 characters and is not null", function() {
    let result = password_is_ok("qew3rtyuioP");
    expect(result).toBe(true);
  });
